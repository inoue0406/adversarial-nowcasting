...
case="result_20201222_traj_clstm_size200_alljapan_advloss_lr0002"

# running script for Rainfall Prediction with ConvLSTM
python ../src/main_trajGRU_advloss_jma.py --model_name clstm\
       ...
       --result_path $case --tdim_use 12 --tdim_loss 12 --learning_rate 0.0000005 --lr_decay 0.9\
       --batch_size 10 --n_epochs 20 --n_threads 4 --checkpoint 10 \
       --loss_function advloss\
